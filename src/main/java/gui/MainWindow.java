...
import automat.CellularAutomat;
import automat.Habitat;
import automat.PaintHabitatEvent;
import automat.PaintHabitatEventObserver;
...
public class MainWindow extends JFrame implements PaintHabitatEventObserver {
	...
	protected CellularAutomat _cellularAutomat;
		...
		btnCompile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					_cellularAutomat = parser.ca_definition();
					if(_cellularAutomat!=null) {
						_drawPanel.setHabitat(_cellularAutomat.getHabitat());						 
					} else {
	...
	private void createNextGeneration() {
		if(_cellularAutomat!=null) {
			Thread t = new Thread(_cellularAutomat);
			t.start();
		}
	}
